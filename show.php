...
{?>
    <tr>
      ...
      <td><button type="button" window.location.href="delete.php?id=<?php echo $Result['ID']; ?>" class="btn btn-danger" >Delete</button> <button type="button" class="btn btn-warning">Change</button></td>
    </tr>
<?php
}
?>
