...
{?>
    <tr>
      ...
      <td><?php echo (<button type="button" onClick="dele(' . $Result['ID'] . ')" class="btn btn-danger">Delete</button>)?><?php echo(<button type="button" class="btn btn-warning">Change</button></td>)?>
    </tr>
<?php
}
?>
